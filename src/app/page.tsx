...
import MImage from "@/components/Image/Image";
          ...
          <EnviloupSideCardSection>
            ...
            <Section>
              <Paragraph className="mb-4">
                ...
                возможных программ на машине Тьюринга. Я придумал эту концепцию
                несколько лет назад, когда изучал C++
              </Paragraph>
              <Paragraph className="mb-4">
                Название концепция получила позже из ролика Азазазынг aka Azazin
                Kreet, где Максос сказал это ржачное слово. Мы же нагло его
                приватизировали и используем!
              </Paragraph>
            ...
            <Section>
              ...
              <ol className="list-decimal ml-4">
                ...
                <li>
                  ...
                  <p>
                    P.s. Здесь уже нас могу выкупить, так как мы реализовали 80%
                    фичей крупных сервисов.
                  </p>
                  <ul className="list-disc ml-4">
                ...
                <li>
                  ...
                  <p>
                    ...
                    замена ютуба по части функционала, остальное решается через
                    инвестиции.
                  </p>
                  <ul className="list-disc ml-4">
        ...
        <Card>
          <EnviloupSideCardSection>
            ...
            <div className="flex flex-col justify-around items-center md:flex-row">
              ...
              <MImage
                className="md:mb-auto rounded-2xl w-[20vw]"
                src="jojopkodev.png"
                alt="tg"
              />
            </div>
